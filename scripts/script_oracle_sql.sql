...
/*
    Creación de la secuencia de cada tabla
*/
CREATE SEQUENCE seq_departamento START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_municipio START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_departamento_municipio START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_puesto START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_empleado START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_reporte_desempeno_vendedor START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_continente START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_lugar_fabricacion START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_vehiculo START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_tipo_garantia START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_calcamonia START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_medio_encontrado START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_potenciales_clientes START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_detalle_potenciales_clientes START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE seq_informe_para_estado START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_encuesta_cliente START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE seq_detalle_venta START WITH 1 INCREMENT BY 1;
